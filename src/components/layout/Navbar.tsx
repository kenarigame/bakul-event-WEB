...
import { Calendar, Menu, Search, User, LogOut, LayoutDashboard, Ticket } from 'lucide-react';
          ...
          <Sheet>
            ...
            <SheetContent side="right">
              <div className="flex flex-col gap-4 mt-8">
                ...
                {isAuthenticated && (
                  <div className="flex flex-col gap-2 mt-4">
                    <Button variant="outline" ><Link to={getDashboardPath()}>Dashboard</Link></Button>
                    <Button variant="ghost" onClick={handleLogout} className="text-destructive justify-start">
